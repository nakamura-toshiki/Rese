...
<div class="show">
    ...
    <div class="reservation">
        <form class="reservation-form" action="{{ route('update', ['reservation_id' => $reservation->id]) }}" method="post">
            @csrf
            <h2 class="reservation-heading">予約</h2>
            <div class="reservation-input">
                <input class="input_field" name="date" type="date" data-target="display_date" value="{{ old('date', $reservation->date) }}">
            </div>
            ...
            <div class="reservation-input">
                <input class="input_field" name="time" type="time" data-target="display_time" value="{{ old('time', $reservation->formatted_time) }}" id="time">
